                            ...
                            <el-tabs>
                                <el-tab-pane :label="trans('users.tabs.data')">
                                    ...
                                    <el-form-item :label="trans('users.form.is activated')"
                                        ...
                                        <el-checkbox v-model="user.is_activated">Activado</el-checkbox>
                                ...
                                <el-tab-pane :label="trans('users.tabs.roles')">
                                    <el-form-item :label="trans('users.tabs.roles')"
                                                  :class="{'el-form-item is-error': form.errors.has('roles') }">
                                        <el-select v-model="user.roles" multiple placeholder="Selecciona">
                                            <el-option
                                                    v-for="role in roles"
                                                    :key="role.id"
                                                    :label="role.name"
